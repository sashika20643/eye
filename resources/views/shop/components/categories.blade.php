    ...
    <div class="container-fluid plr-30">
        <div class="row product-categproes-active">
            ...
            <div class="col-lg-4">
                <!-- categories-list-post-item start -->
                <div class="categories-list-post-item">
                   <img src="{{asset('assets/images/category/2(2).png')}}" alt="">
                   <a href="#" class="category-inner">transition & photocromic glass</a>
                </div>
                <!-- categories-list-post-item end -->
            </div>
            <div class="col-lg-4">
                <!-- categories-list-post-item start -->
                <div class="categories-list-post-item">
                   <img src="{{asset('assets/images/category/3(1).png')}}" alt="">
                   <a href="#" class="category-inner">sunglass</a>
                </div>
                <!-- categories-list-post-item end -->
            </div>
            <div class="col-lg-4">
